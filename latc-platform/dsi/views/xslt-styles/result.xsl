...
<xsl:template match="result" mode="meta">
	<link rel="shortcut icon" href="/images/latc-favicon.gif" type="image/x-icon" /> 
...
<xsl:template match="result" mode="header">
	...
	<header>
		<a href="http://latc-project.eu"><img src="/images/latc-logo.gif"/></a>
    <h1>
      <a href="/">
        <xsl:choose>
...
<xsl:template match="result" mode="footer">
	<footer>
		...
		<p>
			...
			<a href="http://www.axialis.com/free/icons">Icons</a> by <a href="http://www.axialis.com">Axialis Team</a><br/>
			This work is supported by the <a href="http://latc-project.eu">LATC project</a>.
		</p>
