/**
 * @license jQuery Tools
 * 1.2.6 History "Back button for AJAX apps"
 * 
		...
		init : function(els) {
			...
			if ($.browser.msie && $.browser.version < '8') {
				...
				if (!iframe) {
					...
					setInterval(
							function() {
								var idoc = iframe.contentWindow.document, h = idoc.location.hash;
				...
				// other browsers scans for location.hash changes directly
				// without iframe hack
			} else {
