...
public class ConsoleConnection {
	 ...
	 * 
	 * @param url
	 *            The URL of posting data
	 * @param data
	 *            The data that puts on body
	...
	/**
	 * Post report after executing joB <br/>
	 * severity value is <i>info</i> if the job success and <i>warn</i> if job
	 * is failed
	 * 
	 * @param id
	 *            ID of job (random)
	...
	public boolean postReport(String id, VoidInfoDto vi, String apikey) throws Exception {
		...
		NameValuePair[] request = { new NameValuePair("message", vi.getRemarks()),
				new NameValuePair("severity", severity), new NameValuePair("data", data.toString()),
