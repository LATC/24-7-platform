...
public class ReportCSV {
	...
	public void putData(String ID, String Title, String LinkSpec, long ExecuteDate, status st, String reason,
		...
		try {
			out.newLine();
			out.append(ID + ',' + Title.replace("To", "->") + ',' + timeEx + ',' + STATUS + ',' + links + ',' + reason
					+ ',' + LinkSpec + ',' + author);
			out.flush();
		} catch (IOException e) {
	...
	public static void main(String[] args) throws IOException {
		...
		rc.putData("ff8081812cac8e41012cac8e41f50000", "DBPediaToDrugBankdrugs", "http://",
				dt2.getTime() - dt1.getTime(), status.ongoing, "nothing", 12, "myauthor");
		rc.close();
